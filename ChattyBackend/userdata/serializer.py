...
from .models import Users, Profile, ResetPasswordSecureToken
...
class ResetPasswordSecureTokenSerializer(serializers.Serializer):
    class Meta:
        model = ResetPasswordSecureToken
        fields = '__all__'
